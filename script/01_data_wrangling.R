...
## Open stranding datasets
df <- rbind(
  as.data.frame(
    readxl::read_xlsx("./data/strandingDatasetPMP_BS_2015_2020_1.xlsx")),
  as.data.frame(
    readxl::read_xlsx("./data/strandingDatasetPMP_BS_2015_2020_2.xlsx")),
  as.data.frame(
    readxl::read_xlsx("./data/strandingDatasetPMP_BS_2015_2020_3.xlsx")))
...
## Open effort datasets 
ef_SP <- read.csv2("./data/effort_SP_aug2019_jul_2020.csv",
                   header = TRUE, encoding = "UTF-8")
ef_SC_PR <- read.csv2("./data/effort_SC_PR_aug2019_jul_2020.csv",
                      header = TRUE, encoding = "UTF-8")

ef_SP_PR_SC <- rbind(  read.csv2("./data/effort_SC_PR_SP_aug2015_aug_2019_1.csv",
                                 header = TRUE, encoding = "UTF-8"),
                       read.csv2("./data/effort_SC_PR_SP_aug2015_aug_2019_2.csv",
                                 header = TRUE, encoding = "UTF-8"),
                       read.csv2("./data/effort_SC_PR_SP_aug2015_aug_2019_3.csv",
                                 header = TRUE, encoding = "UTF-8"),
                       read.csv2("./data/effort_SC_PR_SP_aug2015_aug_2019_4.csv",
                                 header = TRUE, encoding = "UTF-8"))

## Standardize names for rbind
names_standard <- names(ef_SP) 
names(ef_SP_PR_SC) <- names_standard

## Bind rows
eff <- rbind(ef_SP_PR_SC,ef_SP,ef_SC_PR)

rm(list = c(ls(pattern = "ef_"),"names_standard"))
